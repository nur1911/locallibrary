# Generated by Django 3.2.5 on 2021-07-17 06:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter a brief dicription of the book', max_length=1000)),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genre this book', to='catalog.Genre'),
        ),
    ]
